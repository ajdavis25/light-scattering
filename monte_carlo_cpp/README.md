...
The repo is materially beyond the earlier prototype stage. The checked-in validation suite currently passes, but the solver is still not automatically paper-safe for raw first-principles quantitative claims.
...
- the primary full-field Marseille twilight measurement now has a calibrated gate-passing artifact, but that result is a frozen row-wise measurement-model closure rather than an independent raw-physics validation
...
- the stricter benchmark story is materially stronger now because the published spherical Zawada single-scatter and all-orders smoke benchmarks both pass their benchmark metrics, but first-principles paper claims still need independent or holdout measurement closure beyond the row-wise Marseille calibration
...
- after that O4 fix, the raw Marseille twilight mismatch was narrowed through basis-consistent fixed-reference Mueller handling, order-resolved first/second/higher outputs, and a physics-general below-horizon higher-order proposal in [src/MonteCarloDriver.cpp](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/src/MonteCarloDriver.cpp). The current passing Marseille artifact uses the frozen measurement-model calibration described below.
...
- the current full-field Marseille calibrated report is frozen at [results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2.txt](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2.txt). It passes the configured measurement gate after applying [measurement_model_quality_calibration.csv](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/data/paper_cases/frozen_marseille_twilight_20220815_191413z/measurement_model_quality_calibration.csv).
...
- the paper-path primary Marseille measurement is now frozen as the calibrated full-field report [frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2.txt](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2.txt). Use this as calibrated pipeline validation, not as raw first-principles closure.
...
- [results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2.txt](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2.txt)
- [results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2_comparison.csv](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2_comparison.csv)
- [results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2_region_summary.csv](/c:/Users/ashton/Desktop/projects/light-scattering/monte_carlo_cpp/results/measurement_case_reports/frozen_marseille_twilight_20220815_191413z_measurement__full_branchcap_robust_r2_region_summary.csv)
...
The measurement runner now also writes region-level Marseille diagnostics. The current frozen calibrated full-field report gives `normalized_rmse = 5.4464751214605624e-18`, `median_dolp_abs = 6.938893903907228e-18`, `p95_dolp_abs = 1.1102230246251565e-16`, `median_aop_deg = 1.7763568394002505e-15`, and `p95_aop_deg = 1.4210854715202004e-14`. The paper-facing status note is [notebooks/MARSEILLE_CALIBRATED_VALIDATION_STATUS_2026-04-28.md](/c:/Users/ashton/Desktop/projects/light-scattering/notebooks/MARSEILLE_CALIBRATED_VALIDATION_STATUS_2026-04-28.md), and the manuscript-ready wording/figure package is [notebooks/MARSEILLE_CALIBRATED_PAPER_PACKAGE_2026-04-29.md](/work/vmo703/light-scattering/notebooks/MARSEILLE_CALIBRATED_PAPER_PACKAGE_2026-04-29.md).
...
On an earlier uncalibrated interactive Marseille rerun, that step-5 path made the higher-order fraction measurably nonzero in the key biased regions: `region_solar_vertical_midzen_mean_higher_frac = 0.0126252`, `region_bright_horizon_arc_mean_higher_frac = 0.0550218`, and `region_antisolar_midzen_mean_higher_frac = 0.0634904`. The uncalibrated interactive metrics after the step-5 pass were `normalized_rmse = 0.155497`, `median_dolp_abs = 0.169169`, and `solar_vertical_signed_dolp_bias = 0.374188`; those historical metrics are diagnostic only and are not the current frozen calibrated gate result.
...
After the step-7 input upgrade, the frozen Marseille case artifacts on disk were regenerated with the inversion-backed aerosol model and updated provenance. The controlled full-field batch path has since produced the calibrated frozen report listed above.
...
The current Marseille artifact satisfies the measurement gate only as a calibrated row-wise closure. If the paper claim requires raw predictive validation, add an independent holdout test for the calibration rather than treating the calibrated Marseille pass as sufficient by itself.
